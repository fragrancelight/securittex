...
class MyOrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $status =  TRADE_STATUS_CANCELED_TIME_EXPIRED.",".TRADE_STATUS_ESCROW.','.TRADE_STATUS_PAYMENT_DONE."," ;
        $status .=  TRADE_STATUS_TRANSFER_DONE.",".TRADE_STATUS_CANCELED.','.TRADE_STATUS_REFUNDED_BY_ADMIN .",";
        $status .=  TRADE_STATUS_RELEASED_BY_ADMIN ;
        $coins_type = "BTC";
