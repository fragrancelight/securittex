                                ...
                                <div class="col-md-12">
                                    <div class="profile-info-table">
                                        <ul>
                                            ...
                                            <li>
                                                <span>{{__('Currency Type')}}</span>
                                                <span class="dot">:</span>
                                                <span><strong>{{ $order_details->currency_type }}</strong></span>
                                            </li>
                                            <li>
                                                <span>{{__('Price')}}</span>
                                                <span class="dot">:</span>
                                                <span><strong>{{ $order_details->price }}</strong></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="profile-info-table">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <span class="dot">:</span>
                                                <span>
                                                    {{isset($order_details->reporting_user) ? $order_details->reporting_user->first_name.' '.$order_details->reporting_user->last_name : __('N/A')}}
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
            ...
            @if (isset($order_details->dispute_details) && isset($order_details->dispute_details->assigned_admin) &&
                ...
                <div class="col-6">
                    ...
                    <form id="send_message_form" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="gift_card_order_id" value="{{$order_details->id}}">
                        <div class="row m-4">
                            <div class="w-100">
...
<div class="modal fade" id="assign_to" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('giftCardaAssignDisputeDetails')}}" method="POST">
            @csrf
...
<div class="modal fade" id="refund_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('giftCardRefundDisputeDetails')}}" method="POST">
            @csrf
            <div class="modal-body">
                <div class="row">
                    <input type="hidden" name="dispute_uid" value="{{isset($order_details->dispute_details)?$order_details->dispute_details->uid: '0'}}">
                    <div class="col-md-12">
                        <h4 class="text-white">
                            {{__('Are you sure to refund this order?')}}
                        </h4>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="release_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('giftCardReleaseDisputeDetails')}}" method="POST">
            @csrf
            <div class="modal-body">
                <div class="row">
                    <input type="hidden" name="dispute_uid" value="{{isset($order_details->dispute_details)?$order_details->dispute_details->uid: '0'}}">
                    <div class="col-md-12">
                        <h4 class="text-white">
                            {{__('Are you sure to release this order?')}}
                        </h4>
                    </div>
                </div>
            </div>
...
<script>
    (function($) {
        ...
        jQuery(document).ready(function () {
            ...
            var id = '{{Auth::id().'-'.$order_details->id}}';
            console.log(id);
