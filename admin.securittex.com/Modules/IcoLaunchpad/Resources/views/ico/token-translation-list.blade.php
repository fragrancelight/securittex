                        ...
                        <tbody>
                            @if (isset($language_list))
                                @foreach ($language_list as $language)
                                    <tr>
                                        <td>{{$token_details->token_name}}</td>
                                        <td>{{$language->name}}</td>
                                        <td>
                                            <a class="btn btn-primary" href="{{route('tokenTranslateUpdatePage',['id'=>encrypt($token_details->id),'lan_key'=>$language->key])}}">{{__('Update Text')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
