...
@endsection
@section('sidebar')
@include('blognews::layouts.Sidebar',['menu'=>'dashboarded'])
@endsection
@section('content')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <div class="custom-breadcrumb">
                        <div class="row">
                                <div class="col-12">
                                    <ul>
                                        <li class="active-item">{{__('Blog')}}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="card-body py-0">
                                                <div class="status-card-inner">
                                                    <div class="content">
                                                        <p>{{__('Total Blogs')}}</p>
                                                        <h3>{{ $blogs ?? 0 }}</h3>
                                                        <a href="{{ route('allBlogPage') }}" class=" mt-3 btn btn-sm btn-warning">{{__("Show More")}}</a>
                                                    </div>
                                                    <div class="icon">
                                            ...
                                            <div class="card-body py-0">
                                                <div class="status-card-inner">
                                                    <div class="content">
                                                        ...
                                                        <h3>{{ $comments ??  0}}</h3>
                                                        <a href="{{ route('BlogComment') }}" class=" mt-3 btn btn-sm btn-warning">{{__("Show More")}}</a>
                                                    </div>
                                                    <div class="icon">
                                                        <img src="{{asset('assets/admin/images/status-icons/docfile.svg')}}" class="img-fluid" alt="">
                                                    </div>
