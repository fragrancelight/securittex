                            ...
                            <tbody>
                                @if (isset($language_list))
                                    @foreach ($language_list as $language)
                                        <tr>
                                            <td>{{$blog_post_details->title}}</td>
                                            <td>{{$language->name}}</td>
                                            <td>
                                                <a class="btn btn-primary" href="{{route('blogTranslateUpdatePage',['id'=>encrypt($blog_post_details->id),'lan_key'=>$language->key])}}">{{__('Update Text')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
