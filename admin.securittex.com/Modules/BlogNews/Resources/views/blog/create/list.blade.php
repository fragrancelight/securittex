...
@section('content')
    ...
    <div class="custom-breadcrumb">
        <div class="row">
            <div class="col-12">
                <ul>
                    <li class="active-item">{{__('Blogs')}}</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="user-management">
        ...
        <div class="col-12 ml-0">
            <div class="card-body">
                ...
                <a href="{{ route('createBlogPage') }}" class="btn mr-3 float-right btn-primary">{{ __("Create Blog") }}</a>
                    <div class="table-responsive">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="account_holder_name">{{__('Category')}}</label>
                                    <select id="category" data-type="{{ TYPE_MAIN_CATEGORY }}" class="selectpicker" data-width="100%" data-style="btn-dark">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select id="sub_category" data-type="{{ TYPE_SUB_CATEGORY }}" class="selectpicker" data-width="100%" data-style="btn-dark">
...
<script>
    function getListData(type = 1,main = 0, sub = 0) {
        $('#table-blog').DataTable({
            ...
            pageLength: 25,
            responsive: true,
            ajax: '{{route('blogPostData')}}'+'/'+type+'/'+main+'/'+sub,
            order: [2],
            // autoWidth: true,
            language: {
                paginate: {
